...
* 常用的生成器比如![image-20191119113442629](/Users/haida/Library/Application Support/typora-user-images/image-20191119113442629.png)在加密中因为它的最大周期 état entièrement décrit par leur valeur而变得无用
* 像RC4这样的密码生成器
  * 可能状态的数量比取值的数量更加重要
  * 下一个状态的过渡函数很复杂
  * 初始状态取决于密钥

### 简单生成器的faiblesse![image-20191119114052960](/Users/haida/Library/Application Support/typora-user-images/image-20191119114052960.png)
...
* 交换S[i] S[j]
  ...
  ![image-20191119133308345](/Users/haida/Library/Application Support/typora-user-images/image-20191119133308345.png)
...
* for (i = 0, i ≤ 255) 	![image-20191119134808716](/Users/haida/Library/Application Support/typora-user-images/image-20191119134808716.png)
...
* 最简单的模式：ECB -> 独立块加密
  ...
  ![image-20191119135343136](/Users/haida/Library/Application Support/typora-user-images/image-20191119135343136.png)
...
![image-20191119145103784](/Users/haida/Library/Application Support/typora-user-images/image-20191119145103784.png)
...
* 每一块128bits被认为是一个带有常用约定的16个octets的序列（每一个octet里的每一个bit会被倒序放置），之后这16个octets会按照一定的规定被放在一个4*4的tableau里面
  ...
  ![image-20191119232753520](/Users/haida/Library/Application Support/typora-user-images/image-20191119232753520.png)

* 可以将每一个octet写成一个多项式

  两个octets的加法是模2加法（相当于是每个bit逐个XOR）

  ![image-20191119233251648](/Users/haida/Library/Application Support/typora-user-images/image-20191119233251648.png)
...
* octets的集合有一个**GF(2^8)**的结构
  ...
  * 尤其是所有不为nul的元素有一个**逆元 inverse**，这是多项式m不可缩减的结果
  ...
  ![image-20191120082816601](/Users/haida/Library/Application Support/typora-user-images/image-20191120082816601.png)
...
* 对于每一个在**GF(p^m)**的元素
  ...
  ![image-20191120085604823](/Users/haida/Library/Application Support/typora-user-images/image-20191120085604823.png)
...
![image-20191120103133272](/Users/haida/Library/Application Support/typora-user-images/image-20191120103133272.png)
...
![image-20191028104924757](/Users/haida/Library/Application Support/typora-user-images/image-20191028104924757.png)
...
3. 计算d
   ...
   ![image-20191028110759459](/Users/haida/Library/Application Support/typora-user-images/image-20191028110759459.png)

4. 公钥是(e,n) 私钥是d，销毁p和q

5. 明文m=2

   密文 c=![image-20191028111147365](/Users/haida/Library/Application Support/typora-user-images/image-20191028111147365.png)
...
安全地交换信息——沟通密钥，AES加密信息

交换密钥防止有人窃取——发送者发送RSA的公钥，目的地发送AES的私钥

目的地如何保证收到的公钥是发送者的

公钥加密的弱点——中间人攻击，如果公钥发送的方式是不确定的，可能会被窃取
...
![image-20191028125246454](/Users/haida/Library/Application Support/typora-user-images/image-20191028125246454.png)
...
2. 第二次握手（确认使用的会话密钥）
   ...
   if ok -> 发送经过**服务器的公钥**加密的会话密钥（一次性的？）
